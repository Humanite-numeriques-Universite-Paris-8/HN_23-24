...
#detailModal .modal-content #detailContent p strong {
    ...
    <script>
    const userSessionEmail = "<?php echo $userEmail; ?>"; // Email de l'utilisateur en session PHP
</script>
    ...
    <script>
        ...
        function displayData(data) {
            ...
            data.forEach((row, index) => {
                ...
                // Only display rows where the email matches the session email
                const email = row[6]; // Assuming the email is in the 7th column
